 ...
 * (Pi and Claude Code), both producing the same `SubagentSession` shape.
 * Pi uses `createAgentSession()` in-process; Claude uses the Agent SDK's
 * streaming-input `query()` API.
 */
