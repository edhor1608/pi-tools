...
Pi version review target: this repo was reviewed for Pi `0.79.10` compatibility.
...
- disabled files are removed from the final `<project_context>` section before the model sees it
