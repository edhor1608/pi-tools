...
Pi version baseline: this repo is currently developed and validated against Pi `0.75.5`.
...
Pi docs:
- `https://github.com/earendil-works/pi-mono/tree/main/packages/pi-coding-agent`
- `https://pi.dev`
